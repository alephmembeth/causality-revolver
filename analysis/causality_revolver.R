...
sytsma_livengood_797 <-
  read.delim("sytsma_livengood_797.txt", comment.char = "#")
sytsma_livengood_798 <-
  read.delim("sytsma_livengood_798.txt", comment.char = "#")
