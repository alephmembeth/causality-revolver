...
\usepackage[natbib,authordate,backend=bibtex]{biblatex-chicago}
   \bibliography{causality_revolver_preprint_references}
\usepackage{booktabs}
\usepackage{csquotes}
\usepackage{enumitem}
\usepackage{float}
...
\noindent\textbf{Erratum:} In \autoref{sec:revolver_case_reconsidered}, the $p$ value for F/H was reported as $p < 0.001$.
We corrected it to $p = 0.004$.
...
\label{sec:revolver_case_reconsidered}
...
\begin{figure}[th!]
   \centering
   \includegraphics[width=\textwidth]{figures/causality_revolver_comparison.pdf}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.85\textwidth]{figures/causality_revolver_screen_1.png}
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.85\textwidth]{figures/causality_revolver_screen_2.png}
